...
public:
    ...
    // Update our HairStrand (handles collisions and forces)
    ...
    // Set/Get our HairStrand resolution
    ...
    // Set/Get our HairStrand size (in world coordinates)
...
protected:
    ...
    public:
        ...
        FaceMesh(const HairStrand& m, Face f);
        void Draw(const HairStrand& m);
        void DrawNormals(const HairStrand& m);

        void CalcDistToEye(const HairStrand& m, const vec3& eyePos);
